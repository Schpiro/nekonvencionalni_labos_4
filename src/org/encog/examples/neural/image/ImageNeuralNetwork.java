...
public class ImageNeuralNetwork {
	...
	protected final List<ImagePair> imageList = new ArrayList<ImagePair>();
	...
	public void execute(final String file) throws IOException {
		for(int i = 0; i<11; i++)
		{
			File imageFile = new File("telefonskiBroj.png");
			BufferedImage bufferedImage = ImageIO.read(imageFile);
			bufferedImage = bufferedImage.getSubimage(65*i, 0, 63, 119);
			File pathFile = new File("temporary/" + "crop"+ i +".bmp");
			ImageIO.write(bufferedImage,"bmp", pathFile);
		}
	...
	private void processTrain() throws IOException {
		...
		train.addStrategy(new StopTrainingStrategy(0.1,5000));
